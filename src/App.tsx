...
const NOT_INPUT_KEYS = [
  ...
  // System/Control Keys
  'Escape', 'Tab', 'Enter', 'Insert', 'Delete', 'PrintScreen', 'ScrollLock', 'Pause',
  'ContextMenu', 'Help',
...
function App() {
  ...
  const [wordArray, setWordArray] = useState<string[]>(() => {
    const words = generate({ exactly: 50, minLength: 3, maxLength: 7});
  ...
  return (
    <>
      <ScreenSizeModal darkMode={darkMode}/>
      <Modal
        isOpen={modalOpen}
        onClose={() => {
          reset();
